...
-   To further understand the dynamics, we'll calculate and plot the daily percentage changes for each metric, providing insights into the pandemic's velocity at different stages. Correlation coefficients between the different metrics will be calculated and visualized using scatter plots, helping us understand the relationships between cases, recoveries, and deaths over time.
...
|------------|------------|------------|------------|------------|------------|
| Data Collection    | Incomplete   | Rajitha Reddy, Omid Zandi, Devendran              | 06 Apr 2024 | Moderate | Collection of neccessary data                                      |
| Data Exploration    | Incomplete | Devendran Vemula , Gowtham GopalaKrishnan         | 06 Apr 2024 | Moderate | Cleaning, transformation, Integration of data                                                                                                                                                                      |
| Q1 Time series plot    | Incomplete   | Everyone                                          | 07 Apr 2024 | Moderate | Make mandatory time series plot for the question                                        |
| Q1 Scatter plot | Incomplete   | Devendran Vemula , G Sai Laasya , Rajitha Reddy   | 07 Apr 2024 | Moderate | Make a scatter plot                                                               |
| Q2 Identify trends and patterns | Incomplete   | Mrunali Yadav, Omid Zandi, Gowtham GopalaKrishnan | 07 Apr 2024 | Moderate | analysing the terends and patterns |
| Q2 Anomaly detection  | Incomplete   | G Sai Laasya Mrunali Yadav                        | 09 Apr 2024 | Moderate | Detect the anomaly in the spread of the pandemic                                                                                                                                                                           |
| Q2 Chloropleth map & Bubble maps  | Incomplete   | Omid, Rajitha                                          | 09 Apr 2024 | Moderate | Make chloropleth maps                                                                                                                                                                                  |
| Q2 Spatial map    | Incomplete   | Everyone                                          | 10 Apr 2024 | Moderate | Spatial map

| Presentation & Write up   | Incomplete   | Everyone                                          | 15 Apr 2024 | Moderate | Make presentation & working on writeup
![](images/Timeli.jpg){fig-align="center" width="300"}
