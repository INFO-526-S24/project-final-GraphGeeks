...
| Working on the Bubble Map | Incomplete | G Sai Laasya | 10 Apr 2024 | Moderate | Making a bubble map on the COVID dataset|
| Spatial Map | Incomplete | Omid Zandi | 10 Apr 2024 | Moderate | Creating the spatial maps for the number of cases |
| Time Lapse Visualization | Incomplete | Devendran Vemula | 10 Apr 2024 | Moderate | The progress on the COVID cases or Vaccination |
::: {.column width="50%"}
![](images/Timeli.jpg)
:::
:::
